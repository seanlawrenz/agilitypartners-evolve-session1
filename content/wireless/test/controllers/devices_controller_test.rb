...
class DevicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device" do
    assert_difference('Device.count') do
      post devices_url, params: { device: { make: @device.make, model: @device.model, number: @device.number } }
    end
  ...
  test "should update device" do
    patch device_url(@device), params: { device: { make: @device.make, model: @device.model, number: @device.number } }
